...
const showCardView = document.querySelector('#card-view')
const showListView = document.querySelector('#list-view')
...
function renderCardView() {
  ...
  return listViewActivated = false
}
